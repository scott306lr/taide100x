...
if __name__ == "__main__":
    ...
    model_folder = os.path.join(os.getcwd(), "models", "exllamav2")
    runner_dict = {
        "cuda": [
            {
                "precision": "int4",
                "model_path": os.path.join(model_folder, args.model_name + "4.0-bit"),
            },
            {
                "precision": "int8",
                "model_path": os.path.join(model_folder, args.model_name + "8.0-bit"),
            },
        ]
    }
